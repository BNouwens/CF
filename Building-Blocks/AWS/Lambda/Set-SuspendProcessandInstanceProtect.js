/**
* A sample Lambda function that updates ASG settings to suspend the process
* ReplaceUnhealthy to prevent a failed server being scaled in 
* Use case - a Legacy server that can't be replaced automatically.
* 
* Sample Test Value - if needed
{
    "Records": [
        {
            "EventSource": "aws:sns",
